...
import org.org2.ejml.data.RealMatrix64F;
 ...
 * <ol>
 * <li> Call {@link #setA(org.org2.ejml.data.RealMatrix64F)}
 * <li> Call {@link #solve(org.org2.ejml.data.RealMatrix64F, org.org2.ejml.data.RealMatrix64F)}.
 * </ol>
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li> Call {@link #setA(org.org2.ejml.data.RealMatrix64F)}
 * <li> Call {@link #invert(org.org2.ejml.data.RealMatrix64F)}.
 * </ol>
 ...
 * the input matrices need to be not modified then {@link org.org2.ejml.alg.dense.linsol.LinearSolverSafe} can be used.  The
...
public interface LinearSolver< T extends RealMatrix64F> {
    ...
    /**
     * Computes the inverse of of the 'A' matrix passed into {@link #setA(org.org2.ejml.data.RealMatrix64F)}
    ...
    /**
     * Returns true if the passed in matrix to {@link #setA(org.org2.ejml.data.RealMatrix64F)}
     * is modified.
     *
    ...
    /**
     * Returns true if the passed in 'B' matrix to {@link #solve(org.org2.ejml.data.RealMatrix64F, org.org2.ejml.data.RealMatrix64F)}
     * is modified.
     *
