 ...
 *
 * <p>
 * To create a new instance of SingularValueDecomposition see {@link org.org2.ejml.factory.DecompositionFactory#svd(int, int, boolean, boolean, boolean)}
 * and {@link org.org2.ejml.ops.SingularOps} contains additional helpful SVD related functions.
 * </p>
 *
 * <p>
 * <b>*Note*</b> that the ordering of singular values is not guaranteed, unless done so by a specific implementation.
 * The singular values can be put into descending order while adjusting U and V using {@link org.org2.ejml.ops.SingularOps#descendingOrder(org.org2.ejml.data.DenseMatrix64F, boolean, org.org2.ejml.data.DenseMatrix64F, org.org2.ejml.data.DenseMatrix64F, boolean)}  SingularOps.descendingOrder()}.
 * </p>
 *
 * @author Peter Abeles
 */
