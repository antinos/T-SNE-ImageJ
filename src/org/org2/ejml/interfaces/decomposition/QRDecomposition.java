 ...
 * <li> Can incrementally add and remove columns from the decomposed matrix.  See {@link org.org2.ejml.alg.dense.linsol.qr.AdjLinearSolverQr} </li>
 * </ul>
 * </p>
 * <p>
 ...
 * @see org.org2.ejml.alg.dense.decomposition.qr.QRDecompositionHouseholder_D64
 * @see org.org2.ejml.alg.dense.decomposition.qr.QRDecompositionHouseholderColumn_D64
 *
 * @author Peter Abeles
 */
public interface QRDecomposition <T extends RealMatrix64F>
     ...
     * be called after {@link #decompose(org.org2.ejml.data.RealMatrix64F)} has
     * been called.
     * </p>
     *
     * <p>
     ...
     * called after {@link #decompose(org.org2.ejml.data.RealMatrix64F)} has been.
     * </p>
     * <p>
