...
/**
 * <p>
 * An interface for performing matrix decompositions on a {@link org.org2.ejml.data.DenseMatrix64F}.
 * </p>
 *
 * <p>
...
public interface DecompositionInterface <T extends RealMatrix64F> {
    ...
    /**
     * Is the input matrix to {@link #decompose(org.org2.ejml.data.RealMatrix64F)} is modified during
