...
import org.org2.ejml.alg.dense.mult.VectorVectorMult;
import org.org2.ejml.data.DenseMatrix64F;
import org.org2.ejml.data.MatrixIterator;
import org.org2.ejml.data.ReshapeMatrix64F;
import org.org2.ejml.factory.SingularMatrixException;
import org.org2.ejml.ops.*;
...
public abstract class SimpleBase <T extends SimpleBase> implements Serializable {
     ...
     * </p>
     *
     * @see org.org2.ejml.ops.CommonOps#transpose(DenseMatrix64F,DenseMatrix64F)
     *
     ...
     * </p>
     *
     * @see CommonOps#mult(org.org2.ejml.data.RowD1Matrix64F , org.org2.ejml.data.RowD1Matrix64F , org.org2.ejml.data.RowD1Matrix64F)
     *
     ...
     * </p>
     *
     * @see CommonOps#subtract(org.org2.ejml.data.D1Matrix64F , org.org2.ejml.data.D1Matrix64F , org.org2.ejml.data.D1Matrix64F)
     *
     * @param b m by n matrix. Not modified.
     *
     * @return The results of this operation.
     ...
     * </p>
     *
     * @see CommonOps#subtract(org.org2.ejml.data.D1Matrix64F , double , org.org2.ejml.data.D1Matrix64F)
     *
     ...
     * </p>
     *
     * @see CommonOps#add( org.org2.ejml.data.D1Matrix64F , double , org.org2.ejml.data.D1Matrix64F)
     *
     ...
     * </p>
     *
     * @see CommonOps#add( org.org2.ejml.data.D1Matrix64F , double , org.org2.ejml.data.D1Matrix64F , org.org2.ejml.data.D1Matrix64F)
     *
     * @param b m by n matrix. Not modified.
     *
     * @return A matrix that contains the results.
     ...
     * </p>
     *
     * @see CommonOps#scale(double, org.org2.ejml.data.D1Matrix64F)
     *
     ...
     * </p>
     *
     * @see CommonOps#divide(org.org2.ejml.data.D1Matrix64F,double)
     *
     * @param val Divisor.
     ...
     *
     * @throws org.org2.ejml.factory.SingularMatrixException
     *
     ...
     * </p>
     *
     * @see CommonOps#fill(org.org2.ejml.data.D1Matrix64F , double)
     *
     ...
     * </p>
     *
     * @see org.org2.ejml.ops.NormOps#normF(org.org2.ejml.data.D1Matrix64F)
     *
     ...
     * </p>
     *
     * @see CommonOps#trace(org.org2.ejml.data.RowD1Matrix64F)
     *
     ...
     * </p>
     *
     * @see org.org2.ejml.data.ReshapeMatrix64F#reshape(int,int,boolean)
     *
     ...
     *
     * @see org.org2.ejml.data.DenseMatrix64F#get(int)
     *
     ...
     *
     * @see org.org2.ejml.data.DenseMatrix64F#getIndex(int, int)
     *
     ...
     * The conversion is done using {@link MatrixIO#print(java.io.PrintStream, org.org2.ejml.data.RealMatrix64F)}.
     * </p>
     *
     ...
     * </p>
     *
     * @see org.org2.ejml.ops.CommonOps#extractDiag(DenseMatrix64F, DenseMatrix64F)
     ...
     * </p>
     *
     * @see MatrixIO#saveBin( org.org2.ejml.data.ReshapeMatrix64F, String)
     *
     * @param fileName
