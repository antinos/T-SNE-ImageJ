...
import org.org2.ejml.alg.generic.GenericMatrixOps;
import org.org2.ejml.data.DenseMatrix64F;
import org.org2.ejml.data.ReshapeMatrix64F;
import org.org2.ejml.ops.CommonOps;
import org.org2.ejml.ops.CovarianceRandomDraw;
import org.org2.ejml.ops.RandomMatrices;
...
/**
 * <p>
 * {@link SimpleMatrix} is a wrapper around {@link org.org2.ejml.data.DenseMatrix64F} that provides an
 ...
 *
 * <p>
 * Working with both {@link org.org2.ejml.data.DenseMatrix64F} and SimpleMatrix in the same code base is easy.
 * To access the internal DenseMatrix64F in a SimpleMatrix simply call {@link SimpleMatrix#getMatrix()}.
 * To turn a DenseMatrix64F into a SimpleMatrix use {@link SimpleMatrix#wrap(org.org2.ejml.data.DenseMatrix64F)}.  Not
...
public class SimpleMatrix extends SimpleBase<SimpleMatrix> {
     ...
     * </p>
     *
     * @see org.org2.ejml.data.DenseMatrix64F#DenseMatrix64F(double[][])
     *
     ...
     *
     * @see org.org2.ejml.data.DenseMatrix64F#DenseMatrix64F(int, int) 
     *
     ...
     *
     * @see org.org2.ejml.ops.CommonOps#identity(int)
     *
     ...
     * </p>
     *
     * @see org.org2.ejml.ops.CommonOps#diag(double...)
     *
     ...
     * </p>
     *
     * @see org.org2.ejml.ops.RandomMatrices#setRandom(DenseMatrix64F,java.util.Random)
     *
