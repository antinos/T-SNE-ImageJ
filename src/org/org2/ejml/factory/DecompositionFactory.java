...
package org.org2.ejml.factory;

import org.org2.ejml.EjmlParameters;
import org.org2.ejml.alg.dense.decomposition.chol.CholeskyDecompositionBlock_D64;
import org.org2.ejml.alg.dense.decomposition.chol.CholeskyDecompositionInner_D64;
import org.org2.ejml.alg.dense.decomposition.chol.CholeskyDecompositionLDL_D64;
import org.org2.ejml.alg.dense.decomposition.chol.CholeskyDecomposition_B64_to_D64;
import org.org2.ejml.alg.dense.decomposition.eig.SwitchingEigenDecomposition;
import org.org2.ejml.alg.dense.decomposition.eig.SymmetricQRAlgorithmDecomposition_D64;
import org.org2.ejml.alg.dense.decomposition.eig.WatchedDoubleStepQRDecomposition_D64;
import org.org2.ejml.alg.dense.decomposition.hessenberg.TridiagonalDecompositionHouseholder_D64;
import org.org2.ejml.alg.dense.decomposition.hessenberg.TridiagonalDecomposition_B64_to_D64;
import org.org2.ejml.alg.dense.decomposition.lu.LUDecompositionAlt_D64;
import org.org2.ejml.alg.dense.decomposition.qr.QRColPivDecompositionHouseholderColumn_D64;
import org.org2.ejml.alg.dense.decomposition.qr.QRDecompositionHouseholderColumn_D64;
import org.org2.ejml.alg.dense.decomposition.svd.SvdImplicitQrDecompose_D64;
...
import org.org2.ejml.ops.EigenOps;
import org.org2.ejml.ops.SpecializedOps;
...
public class DecompositionFactory {
    ...
    /**
     * <p>
     * Returns a {@link org.org2.ejml.alg.dense.decomposition.chol.CholeskyDecompositionLDL_D64} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param matrixSize Number of rows and columns that the returned decomposition is optimized for.
    ...
    /**
     * <p>
     * Returns a {@link org.org2.ejml.interfaces.decomposition.QRPDecomposition} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param numRows Number of rows the returned decomposition is optimized for.
     * @param numCols Number of columns that the returned decomposition is optimized for.
