...
package org.org2.ejml.alg.dense.linsol.chol;

import org.org2.ejml.alg.block.BlockMatrixOps;
import org.org2.ejml.alg.block.linsol.chol.BlockCholeskyOuterSolver;
import org.org2.ejml.alg.dense.linsol.LinearSolver_B64_to_D64;
import org.org2.ejml.data.DenseMatrix64F;


/**
 * A wrapper around {@link org.org2.ejml.interfaces.decomposition.CholeskyDecomposition}(BlockMatrix64F) that allows
 * it to be easily used with {@link org.org2.ejml.data.DenseMatrix64F}.
 *
 * @author Peter Abeles
 */
